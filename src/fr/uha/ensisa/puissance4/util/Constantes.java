...
public abstract class Constantes {
	...
	public static final int TAILLE_LIGNE = 4;
	...
	public static final double PLUS_INFINI = Double.POSITIVE_INFINITY;
	public static final double MOINS_INFINI = Double.NEGATIVE_INFINITY;
