...
public abstract class Algorithm {
	...
	public boolean terminalTest(Grille g, int tour)
	{
		if (g.getEtatPartie(symboleMax, tour)!=Constantes.PARTIE_EN_COURS)
		{
			return true;
		}
		if (g.getEtatPartie(symboleMin, tour)!=Constantes.PARTIE_EN_COURS)
		{
			return true;
		}
		return tour>=tourMax;
